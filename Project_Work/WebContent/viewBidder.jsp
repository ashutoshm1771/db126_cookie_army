  ...
  <div class="text-center">
    ...
    <div class="card">
        ...
        <div class="home-container">
            ...
            <div class="flex item-2"> Amount he Bids</div>
            <div class="flex item-3"> Company Reference Number</div>
            <div class="flex item-4"> Establishment Year</div>
            <div class="flex item-5"> Bidder-ID</div>
        ...
        <a class="btn btn-dark btn-lg" href="selectBidder.jsp" role="button">Select This Bidder</a>
</div>
